...
import {
  ...
  useAdminSaveUpgrades,
  useAdminUpgrades,
} from '../../queries/useAdminUpgrades'
...
function AdminUpgradesPage() {
  ...
  const grouped = ['REGEN', 'LUCK', 'DUST_HARVEST', 'TOKEN_VAULT'].map(
    (type) => ({
      type,
      rows: data
                  ...
                  >
                    ...
                    <div className="flex flex-1 items-center gap-2">
                      <Input
                        type="number"
                        step={
                          type === 'LUCK' || type === 'DUST_HARVEST' ? 0.01 : 1
                        }
                        min={0.01}
                        value={c.effect}
                        onChange={(e) =>
