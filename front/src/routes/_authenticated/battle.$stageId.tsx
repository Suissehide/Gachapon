...
// XP progression bar — current XP (violet) + gain from this battle (orange).
function XpBar({
  rewards,
}: {
  rewards: {
  ...
  return (
    <div className="mt-4 w-full rounded-2xl border border-border bg-white p-3">
      ...
      <div className="relative h-2 w-full overflow-hidden rounded-full bg-[rgba(27,23,38,0.08)]">
        {/* Gain from this battle (orange) — rendered FIRST so the violet "current"
            fill can sit on top and hide the ~4% overlap on the left. The overlap
            makes the joint feel like the orange grows from *under* the violet
        ...
        />
        {/* Current XP (violet) — sits on top of the orange overlap. */}
        <div
