...
export const PLAY_TUTORIAL_STEPS: readonly TutorialStep[] = [
  ...
  },
  {
    ...
    text: "Cinq raretés, de commune à légendaire, et des variantes brillantes ou holographiques qui rapportent plus de poussière. La garantie (pitié) t'assure une légendaire au bout d'un certain nombre de tirages.",
  },
  {
