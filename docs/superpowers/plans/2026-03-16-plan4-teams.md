...
**Files:**
- Create: `front/src/routes/_authenticated/index.tsx`

- [ ] **Step 1 : Créer `front/src/routes/_authenticated/index.tsx`**
...
```bash
cd front && npx biome check --write src/routes/_authenticated/index.tsx 2>&1 | tail -5
```

- [ ] **Step 4 : Commit**

```bash
git add front/src/routes/_authenticated/index.tsx \
...
**Files:**
- Create: `front/src/routes/_authenticated/$id.tsx`

- [ ] **Step 1 : Créer `front/src/routes/_authenticated/$id.tsx`**
